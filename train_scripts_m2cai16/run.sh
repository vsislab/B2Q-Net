...
# Training
python3 train.py phase --split cuhk2714 --bn_off --backbone convnextv2 --workers 4 --freeze --seq_len 256 --lr 1e-4 --random_seed --trial_name Step1 --cfg configs/m2cai16.yaml
