...
_C.average_transcript_len = 6.8
_C.bg_class = [0] 
_C.nclasses = 7

#########################
# model
_C.B2Q_Net = B2Q_Net = CN()
B2Q_Net.ntoken = 30
B2Q_Net.mtoken = 30
B2Q_Net.Nw = 16
B2Q_Net.block = "iuUU" # i - input block; u - update block; U - update block with temporal down/up-sample
B2Q_Net.trans = False # if trans is available using training + testing
B2Q_Net.fpos = True
B2Q_Net.cmr = 0.3
B2Q_Net.mwt = 0.0
...
Loss.p2fc = 1.0 # match weight for a2f_attn overlap
